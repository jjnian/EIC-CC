        ...
        <div v-if="!extractedRaw && !loading" class="imp-section">
          ...
          >
            <input
              ...
              type="file"
              multiple
              accept=".pdf,.docx,image/*,audio/*,video/*,.mp3,.wav,.m4a,.aac,.flac,.ogg,.opus,.amr,.mp4,.m4v,.mov,.mkv,.avi,.mpg,.mpeg,.wmv,.flv,application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
              style="display:none"
              @change="onPick"
            />
            <div class="imp-drop-msg">
              ...
              <div class="imp-drop-hint">PDF / DOCX 走文本抽取 · 图片走多模态视觉 · 音频/视频先转写成文本</div>
            </div>
          </div>
