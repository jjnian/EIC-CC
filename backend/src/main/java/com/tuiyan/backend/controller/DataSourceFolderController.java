 ...
 */
@RestController
@RequestMapping("/api/data-source-folders")
public class DataSourceFolderController {

    private final DataSourceFolderRepository repo;

    public DataSourceFolderController(DataSourceFolderRepository repo) {
        this.repo = repo;
    }
